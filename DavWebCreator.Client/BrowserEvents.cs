...
namespace DavWebCreator.Client
{
    public class CEFBrowserEvents : RAGE.Events.Script
    {
        ...
        /// <summary>
        /// Gets called when for example a button was clicked. (It will return all the values & hidden values from the attached elements) (e.g. Button had 3 textboxes applied -> all values of the 3 textboxes are given back.)
        /// </summary>
