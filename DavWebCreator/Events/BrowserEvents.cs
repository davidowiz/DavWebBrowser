...
namespace DavWebCreator.Server.Events
{
    ...
    public class BrowserEvents : Script
    {
        ...
        //{
        //    new VehicleDummy(1, "Sultan RS6", 200, 100, 50, 60, true),
        //    new VehicleDummy(2, "Lambo Diablo GT", 140, 20, 43, 50, false),
        //    new VehicleDummy(3, "Banshee", 120, 30, 23, 45, false),
        //    new VehicleDummy(4, "Glendale", 240, 70, 63, 85, true),
        //    new VehicleDummy(5, "DavMobil", 240, 70, 63, 85, true),
        //    new VehicleDummy(6, "DavMobil", 240, 70, 63, 85, true),
        //    new VehicleDummy(126, "Banshee", 120, 30, 23, 45, false)
        ...
        public void CloseBrowser(Player player)
        { 

            player.TriggerEvent("CLOSE_BROWSER_EXECUTION");
        }

        // Get Client Side Errors and display them in the console to better maintain and find issues. // Comment this out if you dont care about it :D
        [RemoteEvent("BROWSER_TEXT")]
        public void ProvideError(Player player, string error)
        {
            NAPI.Util.ConsoleOutput(error);
        }
        ...
        //[Command("selector")]
        //public void CreateExampleSelection(Player player)
        //{
        ...
        //public void SelectedFishColor(Player player, params object[] args)
        //{
        //    if (args == null)
        //        return;
        ...
        //[Command("card")]
        //public void CreateExampleBoxes(Player player)
        //{
        ...
        //public void BuyVehicle(Player player, params object[] args)
        //{
        //    if (args == null)
        //        return;
        ...
        //public void ShowVehicleDetails(Player player, params object[] args)
        //{
        //    if (args == null)
        //        return;
...
//#endregion
        ...
        //[Command("card2")]
        //public void CreateExampleBoxesWithoutPictures(Player player)
        //{
        ...
        //[Command("noprogress")]
        //public void CreateExampleInactiveProgressBar(Player player)
        //{
        ...
        //[Command("progress")]
        //public void CreateExampleProgressBar(Player player)
        //{
        //    Browser browser = new Browser("ExampleBrowser", BrowserType.Custom, BrowserContentAlign.Center, "100%", "100%");
        //    browser.Margin = "10% 0 0 0";
        ...
        //        ProgressBarFinishedEvent = (Player, progBar) =>
        //        {
        ...
        //[Command("login")]
        //public void CreateExampleLogin(Player player)
        //{
        //    Browser browser = new Browser("ExampleBrowser", BrowserType.Custom, BrowserContentAlign.Center, "100%", "100%");
        //    browser.Margin = "10% 0 0 0";
        ...
        //public void CreateExampleBrowser(Player player)
        //{
        //    Browser browser = new Browser("ExampleBrowser", BrowserType.Custom, BrowserContentAlign.Center, "100%", "100%")
        //    {
        ...
        //public void ButtonClicked(Player player, object[] args)
        //{
        ...
        //public void BrowserCloseEvent(Player player)
        //{
        ...
        //[Command("form")]
        //public void CreateExampleForm(Player player)
        //{
        ...
        //    dropDown.AddDropDownValue("Faction", "7");
        ...
        //    player.SendChatMessage("Widthaw " + withdraw.Value, withdraw.HiddenValue);
     ...
     //   #region YesNo Dialog Example
        ...
        /// <param name="player"></param>
        //[Command("yesno")]
        //public void YesNoDialogExample(Player player)
        //{
        ...
        //public void YesNoExample(Player player, params object[] args)
        //{
        //    if (args == null)
        //        return;
